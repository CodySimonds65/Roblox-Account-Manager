...
internal sealed class NativeEmbeddingTestWindow : IDisposable
{
    ...
    public static NativeEmbeddingTestWindow CreateRoot(int x, int y, int width, int height) =>
        Create(WsPopup | WsVisible, x, y, width, height);

    private static NativeEmbeddingTestWindow Create(int style, int x, int y, int width, int height)
    {
